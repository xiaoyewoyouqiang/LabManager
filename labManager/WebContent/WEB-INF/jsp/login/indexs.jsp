...
<script src="${ctx}/resource/assets/laydate/laydate.js"
	type="text/javascript"></script>
<script src="${ctx}/resource/js/jquery.nicescroll.js"
	type="text/javascript"></script>
...
<body>
			...
			<div class="navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						style="background: #1D3557; color: #fff; padding: 0;"> <span
							class="time" style="background-color: #fff;"><em id="time"
								style="color: #337ab7"></em></span><span class="user-info"
							style="max-width: 142px; text-overflow: initial; padding: 11px 0 0 10px;"><small
						...
						<ul
							...
							<li class="divider"></li>
							<li><a href="login_tuichu.do" id="Exit_system"><i
	...
	<div class="main-container" id="main-container">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)"
							name="notice_list.do" class="iframeurl" title=""><i
								class="icon-home"> <?xml version="1.0" standalone="no"?> <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN" "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd">
      ...
      <g
											transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
											fill="#fff" stroke="none">
        <path
											d="M0 160 l0 -160 160 0 160 0 0 160 0 160 -160 0 -160 0 0 -160z m204
    ...
    43 17 20 32 36 35 36 3 0 23 -18 44 -39z" />
        <path
											d="M135 240 c-18 -20 -17 -20 25 -20 42 0 43 0 25 20 -10 11 -21 20 -25
    20 -4 0 -15 -9 -25 -20z" />
        <path
											d="M40 120 l0 -70 120 0 120 0 0 70 0 70 -120 0 -120 0 0 -70z m198 43
    ...
    -4 45 -15z" />
							...
							</i><span class="menu-text"> 通知管理 </span></a></li>
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-group"> <?xml version="1.0" standalone="no"?> <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
...
Created by potrace 1.13, written by Peter Selinger 2001-2015
  ...
  <g transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
    ...
    <path
											d="M0 210 c0 -105 1 -109 18 -92 11 11 16 27 14 45 -3 15 1 34 8 42 15
...
-160 0 -160 0 0 -110z" />
    <path
											d="M160 235 c-7 -8 -10 -25 -6 -39 10 -41 72 -42 82 0 8 30 -11 54 -41
54 -12 0 -28 -7 -35 -15z" />
    <path
											d="M60 185 c-10 -11 -10 -19 -2 -27 15 -15 44 -2 40 19 -4 23 -22 27
-38 8z" />
  </g>
</svg>
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="user_list.do" title="用户管理" class="iframeurl"> <i
										class="icon-double-angle-right"> <?xml version="1.0" standalone="no"?>
...
Created by potrace 1.13, written by Peter Selinger 2001-2015
  ...
  <g transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
													fill="#ffffff" stroke="none">
    <path
													d="M0 160 l0 -160 175 0 175 0 0 160 0 160 -175 0 -175 0 0 -160z m298
...
92 21 14 222 11 236 -3z" />
    <path d="M80 185 l0 -65 100 0 101 0 -3 63 -3 62 -97 3 -98 3 0 -66z" />
  </g>
</svg>
									</i>用户列表
								</a></li>
						...
						<c:if test="${role == 'js'}">
							<li><a href="#" class="dropdown-toggle"><i
									class="icon-bookmark"></i><span class="menu-text">
										设备借用管理 </span><b class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home"><a href="javascript:void(0)"
										name="equipment_dataList3.do" title="设备借用管理" class="iframeurl"><i
						...
						<c:if test="${role != 'xs'}">
							<li><a href="#" class="dropdown-toggle"><i
									class="icon-desktop"> <?xml version="1.0" standalone="no"?>
										<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
 "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd"> <svg
											version="1.0" xmlns="http://www.w3.org/2000/svg"
											width="28.000000pt" height="25.600000pt"
...
92 21 14 222 11 236 -3z" />
    <path d="M80 185 l0 -65 100 0 101 0 -3 63 -3 62 -97 3 -98 3 0 -66z" />
								...
								<ul class="submenu">
									...
									<li class="home"><a href="javascript:void(0)"
										name="laboratory_list2.do" title="实验室列表" class="iframeurl">
											<i class="icon-double-angle-right"></i>实验室预约
									</a></li>

									<li class="home"><a href="javascript:void(0)"
										name="laboratory_listcopy.do" title="规章制度" class="iframeurl">
					...
					<c:if test="${role == 'admin'||role == 'xs'}">
						...
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-cogs"> <?xml version="1.0" standalone="no"?> <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
 "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd"> <svg
										version="1.0" xmlns="http://www.w3.org/2000/svg"
										width="25.600000pt" height="25.600000pt"
										viewBox="0 0 25.600000 25.600000"
...
Created by potrace 1.13, written by Peter Selinger 2001-2015
  ...
  <g transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
											fill="#ffffff" stroke="none">
    <path
											d="M0 160 l0 -160 160 0 160 0 0 160 0 160 -160 0 -160 0 0 -160z m308
...
-123z" />
    ...
    <path
											d="M40 155 l0 -25 120 0 120 0 0 25 0 25 -120 0 -120 0 0 -25z m228 -2
c2 -8 -6 -13 -22 -13 -25 0 -33 10 -19 24 10 10 36 3 41 -11z" />
    <path
											d="M40 75 l0 -25 120 0 120 0 0 25 0 25 -120 0 -120 0 0 -25z m228 3
c-6 -17 -40 -17 -45 0 -3 7 5 12 22 12 17 0 25 -5 23 -12z" />
  </g>
</svg>
							</i><span class="menu-text"> 实验课程与设备管理 </span><b
								class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="equipment_list.do" title="实验课程与设备详情管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>实验课程与设备详情管理</a></li>
								<c:if test="${role == 'xs'}">
									<li class="home"><a href="javascript:void(0)"
					...
					<c:if test="${role == 'admin'}">
						<li class="home"><a href="javascript:void(0)"
							name="equipment_dataList2.do" title="固定资产管理" class="iframeurl"><i
								class="icon-double-angle-right"></i>固定资产管理</a></li>
					</c:if>
					</ul>
					</li>
					...
					<c:if test="${role == 'admin'||role == 'xs'}">
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-bookmark"> <?xml version="1.0" standalone="no"?>
									<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
 "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd"> <svg
										version="1.0" xmlns="http://www.w3.org/2000/svg"
										width="25.600000pt" height="25.600000pt"
...
Created by potrace 1.13, written by Peter Selinger 2001-2015
  ...
  <g transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
											fill="#ffffff" stroke="none">
    <path
											d="M0 160 l0 -160 160 0 160 0 0 160 0 160 -160 0 -160 0 0 -160z m248
...
-3 0 -55z" />
    <path
											d="M205 240 c-18 -19 -18 -22 -2 -37 16 -16 18 -16 37 3 20 20 20 21 2
37 -18 16 -20 16 -37 -3z" />
    <path
											d="M60 226 c0 -35 1 -36 36 -36 34 0 35 1 32 33 -3 28 -7 32 -35 35 -32
3 -33 2 -33 -32z" />
    <path
											d="M60 96 c0 -35 1 -36 36 -36 34 0 35 1 32 33 -3 28 -7 32 -35 35 -32
3 -33 2 -33 -32z" />
    <path
											d="M190 95 c0 -33 2 -35 35 -35 33 0 35 2 35 35 0 33 -2 35 -35 35 -33
0 -35 -2 -35 -35z" />
  </g>
</svg>
					...
					<c:if test="${role == 'admin'}">
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-list"> <?xml version="1.0" standalone="no"?> <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
 "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd"> <svg
										version="1.0" xmlns="http://www.w3.org/2000/svg"
										width="25.600000pt" height="25.600000pt"
										viewBox="0 0 25.600000 25.600000"
...
Created by potrace 1.13, written by Peter Selinger 2001-2015
  ...
  <g transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
											fill="#ffffff" stroke="none">
    <path
											d="M0 160 l0 -160 160 0 160 0 0 160 0 160 -160 0 -160 0 0 -160z m210
...
0 58 20 68 60 30 37 -36 50 -15 15 26 -33 40 -20 59 42 59 37 0 50 -5 73 -30z" />
    <path
											d="M138 247 c12 -13 22 -28 22 -33 0 -12 -43 -54 -55 -54 -5 0 -19 10
...
-74 95 l-25 0 21 -23z" />
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="repair_repairlist.do" title="设备维修管理" class="iframeurl"><i
...
Created by potrace 1.13, written by Peter Selinger 2001-2015
  ...
  <g transform="translate(0.000000,25.600000) scale(0.080000,-0.080000)"
											fill="#ffffff" stroke="none">
    <path
											d="M0 160 l0 -160 35 0 c19 0 35 2 35 5 0 2 -12 15 -26 28 -25 23 -25
25 -22 155 2 101 0 132 -9 132 -10 0 -13 -39 -13 -160z" />
    <path
											d="M260 307 c0 -7 9 -18 21 -25 19 -12 20 -21 17 -147 -2 -103 0 -135
10 -135 9 0 12 39 12 160 l0 160 -30 0 c-17 0 -30 -5 -30 -13z" />
    <path
											d="M40 181 c0 -69 4 -122 10 -126 6 -4 10 33 10 103 0 78 4 113 13 120
7 6 49 13 92 15 77 3 76 3 -22 5 l-103 2 0 -119z" />
    <path
											d="M84 257 c-2 -7 -3 -62 -2 -123 l3 -109 98 -3 98 -3 -3 123 -3 123
...
-60 -10 -33 0 -60 4 -60 10 0 6 27 10 60 10 33 0 60 -4 60 -10z" />
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="laboratorylog_list.do" title="实验室预约人统计表"
									class="iframeurl"> <i class="icon-double-angle-right"></i>实验室预约人统计表
								</a>
								<li class="home"><a href="javascript:void(0)"
									name="equipmentlog_list.do" title="设备借用统计表" class="iframeurl"><i
										class="icon-double-angle-right"></i>设备借用统计表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="repair_list.do" title="报废设备报修表" class="iframeurl"><i
										class="icon-double-angle-right"></i>报废设备报修表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="user_listcopy.do" title="用户统计报表" class="iframeurl"> <i
										class="icon-double-angle-right"></i>用户统计报表
								</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="laboratory_list2copy.do" title="实验室预约情况统计表"
									class="iframeurl"> <i class="icon-double-angle-right"></i>实验室预约情况统计表
								</a></li></li>
						</ul>
						</li>
					</c:if>
		...
		<path fill="#ffffff" stroke="none"
											d="M0 320 l0 -320 320 0 320 0 0 320 0
		320 -320 0 -320 0 0 -320z" />
		<path fill="#707070" stroke="none"
											d="M477 337 c113 -196 125 -221 115 -243
		l-12 -24 -260 0 -260 0 -11 24 c-13 27 -22 8 163 329 77 133 81 138 110 135
		28 -3 39 -19 155 -221z" />
		<path fill="#ffffff" stroke="none"
											d="M221 303 l-91 -158 95 -3 c52 -1 138
		-1 190 0 l95 3 -91 158 c-50 86 -94 157 -99 157 -5 0 -49 -71 -99 -157z" />
		<path fill="#707070" stroke="none"
											d="M350 325 l0 -75 -30 0 -30 0 0 75 0 75
		30 0 30 0 0 -75z" />
		<path fill="#707070" stroke="none"
											d="M345 200 c0 -18 -6 -26 -23 -28 -24 -4
		-38 18 -28 44 3 9 15 14 28 12 17 -2 23 -10 23 -28z" />
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="feedback_fb.do" title="设备故障反馈" class="iframeurl"> <i
	...
	<g transform="translate(0.000000,25.600000) scale(0.040000,-0.040000)"
											fill="#ffffff" stroke="none">
	<path class="path-color" fill="#f9f9f9" stroke="none"
											d="M0 320 l0 -320 320 0 320 0 0 320 0
	320 -320 0 -320 0 0 -320z" />
	<path class="path-color2" fill="#585858" stroke="none"
											d="M477 337 c113 -196 125 -221 115 -243
	l-12 -24 -260 0 -260 0 -11 24 c-13 27 -22 8 163 329 77 133 81 138 110 135
	28 -3 39 -19 155 -221z" />
	<path class="path-color3" fill="#ffffff" stroke="none"
											d="M221 303 l-91 -158 95 -3 c52 -1 138
	-1 190 0 l95 3 -91 158 c-50 86 -94 157 -99 157 -5 0 -49 -71 -99 -157z" />
	<path class="path-color2" fill="#585858" stroke="none"
											d="M350 325 l0 -75 -30 0 -30 0 0 75 0 75
	...
	-38 18 -28 44 3 9 15 14 28 12 17 -2 23 -10 23 -28z" />
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="feedback_fblist.do" title="设备故障反馈" class="iframeurl">
			...
			<div class="main-content">
				...
				<iframe id="iframe"
					...
					name="iframe" frameborder="0" src="user_list.do"></iframe>
