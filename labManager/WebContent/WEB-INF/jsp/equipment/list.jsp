...
<body>
							...
							<c:forEach items="${pagers.datas}" var="c" varStatus="l">
								<tr>
									...
									<td><c:if test="${c.state == 0}">
										...
										</c:if> <c:if test="${c.state == 2 || c.state == 3}">
	...
	<form action="equipment_save.do" method="post"
		...
		<div class="add_menber" id="add_menber_style" style="display: none;list-style: none">
			<ul>
				<!-- <li class="adderss"><label class="label_name"
					style="width: 130px">实验课程：</label> <span class="add_name"> <input
						name="bz" type="text" id="实验课程" class="text_add"
						style="width: 350px" />
				</span></li> -->
			</ul>
			...
			<li><label class="label_name" style="width: 130px">地点：</label>
				<span class="add_name"> <input name="zzs" type="text"
					id="地点" class="text_add" />
			</span>
